...
/*in g_pfnFWEnteringCbltTrans, 3 primary steps must be done: 1. evaluateÇóÖµ g_nMaxCbltBytes, 2. sysIntEnable, 3. evaluate g_nCbltAdrs*/
...
extern int		g_bStatusSend;
extern int		g_bShutdownOpt;
...
extern unsigned int CbltMsgNum;
extern unsigned int NetMsgNum;
...
extern int 			g_bTrgStop;
extern int			g_bEMCMonitor;

extern int			g_bEMCMonictrl;
